...
create table UNION_OF_MEASURE (
 id serial,
 name varchar(100)
);
insert into UNION_OF_MEASURE (name) values ('грамм');
insert into UNION_OF_MEASURE (name) values ('килограмм');
insert into UNION_OF_MEASURE (name) values ('центнер');
insert into UNION_OF_MEASURE (name) values ('карат');
insert into UNION_OF_MEASURE (name) values ('тонна');
-- Валюты
